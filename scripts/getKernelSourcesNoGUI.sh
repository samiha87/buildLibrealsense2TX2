...
sudo tar -xvf /media/reski/Reski/public_sources.tbz2 Linux_for_Tegra/source/public/kernel_src.tbz2
tar -xvf /media/reski/Reski/Linux_for_Tegra/source/public/kernel_src.tbz2
...
rm -r /media/reski/Reski/Linux_for_Tegra
